    ...
    <ul class="navbar-nav">
      ...
      <li class="dropdown-content nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="/JspProject/project/aisw/community/freeboard/freeboard_list.jsp?table=dataroom">서식자료실</a>
        </div>
      </li>
    </ul>
    <form class="d-flex">
...
<div class="main-notice-box temp08">
	...
	<li>
		<p class="mini-date"><span>09 </span>22.05</p>
		<div class="mini-txt-box">
			<p class="mini-title"><a href="community/freeboard/freeboard_read.jsp?table=freeboard&id=1&page=1" title="자세히보기">ㄱㄷㅅ첫번재극ㄹㄹ 란일닙지</a></p>
			<p class="mini-txt"><a href="community/freeboard/freeboard_read.jsp?table=freeboard&id=1&page=1" title="자세히보기">ㄱ숏교쇿교</a></p>
		</div>
	</li>
...
<div class="main-notice-box temp08">
 ...
 <li>게시판에 올린 글이 없습니다</li>
					...
					</div><a class="btn-more" href="community/freeboard/freeboard_list.jsp?table=gallery" target="_blank" title="갤러리 바로가기">더보기</a></li>
				</ul>
			</div>
		</div>
...
<div class="main-notice-box temp08">
	...
	<li>
		<p class="mini-date"><span>09 </span>22.05</p>
		<div class="mini-txt-box">
			<p class="mini-title"><a href="community/freeboard/freeboard_read.jsp?table=dataroom&id=1&page=1" title="자세히보기">1</a></p>
			<p class="mini-txt"><a href="community/freeboard/freeboard_read.jsp?table=dataroom&id=1&page=1" title="자세히보기">1 </a></p>
		</div>
	</li>
