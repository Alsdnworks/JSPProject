...
<SCRIPT>
	...
	function rimgchg(p1, p2) {
		if (p2 == 1)
			document.images[p1].src = "./ch10_first_update/image/open.gif";
		else
			document.images[p1].src = "./ch10_first_update/image/arrow.gif";
	}
	...
	function imgchg(p1, p2) {
		if (p2 == 1)
			...
			document.images[p1].src = "./ch10_first_update/image/close.gif";
	}
</SCRIPT>
...
<P>
<P align=center>
	<FONT color=#0000ff face=굴림 size=5><STRONG>공지사항</STRONG></FONT>
</P>
<P>
<CENTER>
	<TABLE class="table">
			...
			<div class="container_div">
				...
				<div align=right>
					<A href="freeboard_write.jsp">
						<img src="./ch10_first_update/image/write.gif" class="img-fluid">
					</A>
				</div>
			</div>
		</FORM>