			...
			<div class="col-sm-10">
				<ul>
					<li>
						<span>성명</span>
						<p>
							<span class="b-name"> 최승교 </span> <span>교수</span>
						</p>
					</li>
					<li>
						<span>연구분야</span>
			...
			<div>
				<div class="row">
					<div class="col-sm-6 text-center">
						<a href="#paper" class="tabLink" data-id="thesis" title="주요논문"> 주요논문 </a>
					</div>
					<div class="col-sm-6 text-center">
						<a href="#pager" class="tabLink" data-id="book" title="저서"> 저서 </a>
					</div>
				</div>
				<br>
